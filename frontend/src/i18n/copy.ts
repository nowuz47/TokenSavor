...
export const copy = {
  en: {
    ...
    dashboard: {
      ...
      aiWorkSaved: "AI Work Saved",
      taskOptimization: "Task Optimization",
      tokenSavingRequests: "Token-saving Requests",
      zeroTokenTaskOptimizations: "0-token Work Optimizations",
      expectedFollowupReduction: "Expected Follow-up Reduction",
  ...
  ko: {
    ...
    dashboard: {
      ...
      aiWorkSaved: "AI 작업 절약",
      taskOptimization: "작업 최적화",
      tokenSavingRequests: "토큰 절감 요청",
      zeroTokenTaskOptimizations: "0토큰 작업 최적화",
      expectedFollowupReduction: "예상 재질문 감소",
